...
```{r NewColumnsParacou, message=FALSE, warning=FALSE, paged.print=TRUE}
...
We use the brms package [@burkner_brms_2017 ; @burkner_advanced_2018] in Rstudio to implement the model.
...
Moran's test function function was re-written from the ape package's Moran.I function [@paradis_ape_2019] in order to be able to select the pairs of neighbours which are less than 100 m apart. The p-values are obtained with a "greater" alternative hypothesis.
...
```{r ModelsSignificanceMoran, message=FALSE, warning=FALSE}
