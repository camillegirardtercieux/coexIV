...
$Y_{i,j,t} = \beta_{0j} + \beta_{1j} * ln(X_{1ijt}) + \beta_{2j} * X_{2ijt} + \ldots + \beta_{Nj} * X_{Nijt}$
...
```{r Basic parameters, include=FALSE}
...
```{r Species parameters, include=FALSE}
...
```{r Spatial models, include=FALSE}
...
```{r Environmental variables, eval=FALSE, include=FALSE}
...
```{r Second observation, echo=FALSE}
# Second observation
...
```{r Individual coordinates, echo=FALSE}
...
```{r Growth plots, message=FALSE, include=FALSE}
# Plot the data
...
```{r Plots_growth_light, echo=FALSE, fig.show="hold", out.width="50%"}
...
```{r Plots_growht_light_IV, echo=FALSE, fig.show="hold", out.width="50%"}
...
```{r Histograms_growth, echo=FALSE, fig.show="hold", out.width="50%"}
...
```{r Histograms_growth_IV, echo=FALSE, fig.show="hold", out.width="50%"}
...
```{r brms models, eval=FALSE, include=FALSE}
...
```{r Graphic without genetic variability, echo=FALSE}
...
```{r Semivariogram figure, echo=FALSE, warning=FALSE}
