...
```{r TraceSp1, fig.cap="Trace of the posterior of the model for Species 1 without genetic IV"}
...
```{r TraceSp2, fig.cap="Trace of the posterior of the model for Species 2 without genetic IV"}
...
```{r TraceIVSp1, fig.cap="Trace of the posterior of the model for Species 1 with genetic IV"}
...
```{r TraceIVSp2, fig.cap="Trace of the posteriors of the model for Species 2 with genetic IV"}
