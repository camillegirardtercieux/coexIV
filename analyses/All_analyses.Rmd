...
```{r ModelUppangala, include=FALSE}
...
save(brms_mod, file = here::here("outputs", "tropical_analysis", "brms_mod_BCI.RData_revision"))

```

```{r LoadModelBCI, include=FALSE}
load(here::here("outputs", "tropical_analysis", "brms_mod_BCI.RData_revision"))
```
...
```{r LoadMoran, eval=FALSE, include=FALSE}
...
```{r MoransResults, eval=FALSE, include=FALSE}
...
```{r ModelsSignificanceMoran, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
```{r LoadVarianceComparison, eval=FALSE, include=FALSE}
...
```{r ResultsVarianceComparison, eval=FALSE, include=FALSE}
...
```{r ResultsVarianceComparisonSample, eval=FALSE, include=FALSE}
...
```{r ResultsMoranParacouUndisturbed, eval=FALSE, include=FALSE}
...
save(brms_mod, file = here::here("outputs", "clonal_analysis", "brms_mod_revision.RData"))
```
...
load(here::here("outputs", "clonal_analysis", "brms_mod_revision.RData"))
```
...
Vars_t1[,3] <- Vars_t1[,3] + abs(rnorm(1, mean=0, sd=0.5))
Vars_t1[,2+changing_variables[1]] <- Vars_t1[,2+changing_variables[1]] + abs(rnorm(1, mean=0, sd=0.5))
Vars_t1[,2+changing_variables[2]] <- Vars_t1[,2+changing_variables[2]] + abs(rnorm(1, mean=0, sd=0.5))
Vars_t1[,2+changing_variables[3]] <- Vars_t1[,2+changing_variables[3]] - abs(rnorm(1, mean=0, sd=0.5))
Vars_t1[,2+changing_variables[4]] <- Vars_t1[,2+changing_variables[4]] - abs(rnorm(1, mean=0, sd=0.5))
Vars_t1[,2+changing_variables[5]] <- Vars_t1[,2+changing_variables[5]] + rnorm(1, mean=0, sd=0.5)
...
$V_{bj} \sim \mathcal{Student's T}(3, 0, 2.5)$, $j = [1, 2]$, iid
...
Fig_1 <- ggpubr::ggarrange(plot_A, plot_B, plot_C, plot_D,
                           labels=c("a", "b", "c", "d"),
                           widths = c(1,1.3),
                           hjust=c(-4, -4, -4, -4),
                           vjust=c(2, 2, 2, 2))
