...
Figure \@ref(fig:SummaryPlot) presents a graphical summary of the analysis.
...
We evaluate the convergence of the model using trace and density plots of the posterior estimates.
