...
```{r PlotsGrowthLight, echo=FALSE, fig.show="hold", out.width="33%", fig.cap="The original data, the data without negative growth values and the loged growth."}
...
```{r PlotColoursDate, echo=FALSE, fig.cap="Plot of the growth versus the diameter. Each colour represents a different census."}
...
Here is the layout of a plot :

```{r Coordinates, echo=FALSE, fig.cap="Design of a plot. Each point is a tree and the associated number is the tag of the tree."}
...
```{r TracePosteriors, echo=FALSE, fig.cap="Trace of the posteriors"}
...
```{r DensityPosteriors, echo=FALSE, fig.cap="Density of the posteriors"}
...
```{r TemporalRandomEffects, echo=FALSE, fig.cap="Trace of the temporal random effects"}
...
```{r GenotypeRandomEffects, echo=FALSE, fig.cap="Trace of the genotype random effects"}
...
```{r SpatialRandomEffects, echo=FALSE, fig.cap="Trace of the site random effects."}
...
```{r PlotsRanef, echo=FALSE, fig.show="hold", out.width="33%", fig.cap="Values of the random effects."}
...
```{r Piechart, echo=FALSE, fig.cap="Proportion of each variance component of the unexplained variance."}
Res_var_partition <- data.frame(
